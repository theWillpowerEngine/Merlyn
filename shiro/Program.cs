...
namespace Shiro.Cons
{
    class Options
    {
        ...
        public string EntryModule = null;
        public string[] Files;
    ...
    class Program
    {
        ...
        private static void SetOptionsFromCmdLine(string[] args)
        {
            ...
            switch (args[0])
            {
                ...
                case "libs":
                case "libraries":
                    var libs = Libraries.GetAvailable(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location));
                    Console.WriteLine("Available/Known Libraries: ");
                ...
                case "help":
                    ...
                    Console.WriteLine("    Commands:  compile, run, install, uninstall, libs/libraries, help");
                    Console.WriteLine("    args:");
                    Console.WriteLine("      -sr - Show result of evaluation");
            ...
            if (Options.EntryModule == null && Options.Files.Length > 0)
                Options.EntryModule = files[0].Split('.')[0];
        }

        private static void RegisterAutos(Interpreter shiro)
        {
